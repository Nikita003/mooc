...
<title>Home | StudyingNotes</title>
...
<div class="container">
    ...
    {% if settings.SITE_TITLE %}<a class="brand" href="/">Studying Notes</a>{% endif %}
    <ul class="nav">
    ...
    <div class="nav-collapse">
        <div class="pull-right">
            <a class="btn btn-small btn-warning no-pjax" href="{% url "link_create" %}">New Link or Notes</a>
        </div>
